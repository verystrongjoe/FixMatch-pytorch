...
for p in 0.1 # 0.05 0.1 0.25 0.5 1.0
do
    for k in 1 2 3 5
    do
        CUDA_VISIBLE_DEVICES=1 python -m train_baseline_pretrained --K $k --project-name waferfix_baseline_pretrained5 --proportion $p --arch resnet18 --batch-size 256 --lr 0.003  --seed 5
    done
done
