...
CUDA_VISIBLE_DEVICES=1 python -m train_ensemble --K 2 --project-name waferfix-ensemble --proportion 0.05 --arch resnet18 --batch-size 256 --lr 0.003  --seed 5
CUDA_VISIBLE_DEVICES=1 python -m train_ensemble --K 3 --project-name waferfix-ensemble --proportion 0.05 --arch resnet18 --batch-size 256 --lr 0.003  --seed 5
