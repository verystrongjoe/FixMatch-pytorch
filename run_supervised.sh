...
CUDA_VISIBLE_DEVICES=0 python -m train_supervised --wandb --epochs 300 --project-name waferfix-rebuttal-supervised  --gpus 0 --proportion 1.0  --dataset wm811k --arch densenet121 --batch-size 128 --lr 0.003 --expand-labels --seed 5 --out results/rebuttal-densenet121-wm811k-supervised-1.0
CUDA_VISIBLE_DEVICES=0 python -m train_supervised --wandb --epochs 300 --project-name waferfix-rebuttal-supervised  --gpus 0 --proportion 0.5 --dataset wm811k --arch densenet121 --batch-size 128 --lr 0.003 --expand-labels --seed 5 --out results/rebuttal-densenet121-wm811k-supervised-0.5
