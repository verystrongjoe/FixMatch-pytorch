...
CUDA_VISIBLE_DEVICES=1 python -m train_supervised --epochs 300 --gpus 1 --wandb --project-name waferfix-seed-check --proportion 0.50 --dataset wm811k --arch resnet18 --batch-size 256 --lr 0.003 --expand-labels --seed 5 --out results/wm811k-supervised-0.50
